...
CREATE TABLE IF NOT EXISTS delta(
    ...
    ATTACK_UPGRADE_PRICE INT DEFAULT 5,
    DEFENCE_UPGRADE_PRICE INT DEFAULT 10,
    HEALTH_UPGRADE_PRICE INT DEFAULT 5,
    FOREIGN KEY (PLAYER_ID) REFERENCES GAME_STATS(PLAYER_ID)
);
